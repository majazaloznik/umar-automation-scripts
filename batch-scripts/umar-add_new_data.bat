...
"C:\Program Files\R\R-4.5.2\bin\x64\Rscript.exe"  -e "source('\\\\192.168.38.7\\public$\\Avtomatizacija\\umar-automation-scripts\\R\\umar-add_new_data_full.R')" > \\192.168.38.7\public$\Avtomatizacija\umar-automation-scripts\logs\umar-add_new_data_full.Rout 2>&1
