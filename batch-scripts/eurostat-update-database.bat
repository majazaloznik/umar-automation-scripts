@ECHO OFF
Rem this is for running the eurostat-update-database.R script which updates all the eurostat series in the platform database.
...
git add  logs\eurostat-update-database.Rout
