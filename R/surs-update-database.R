...
# UMARaccessR::create_selection_excel(df, outfile = "O:\\Users\\MZaloznik\\seznam_serij")

# # update html report
rmarkdown::render("M:/analysis/umar_master_report/docs/html_test.Rmd",
                  output_file = "O:/Avtomatizacija/data-platform/indikatorji_test.html")
